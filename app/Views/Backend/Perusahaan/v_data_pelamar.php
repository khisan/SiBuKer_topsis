              ...
              <tbody>
                ...
                foreach ($pelamar as $key => $hasil) { ?>
                  <tr>
                    ...
                    <td>
                      <a href="/Backend\Perusahaan\Pelamar\setuju/<?= $hasil['id_lamar'] ?>" class="btn btn-success"><i class="mdi mdi-check"></i></a>
                      <a href="/Backend\Perusahaan\Pelamar\tolak/<?= $hasil['id_lamar'] ?>" class="btn btn-danger"><i class="mdi mdi-close"></i></a>
