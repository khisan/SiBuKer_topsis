        ...
        <div class="card-body">
          ...
          <form class="form-horizontal form-material" action="/backend/admin/lowongan/update/<?= $lowongan['id_lowongan'] ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <input type="text" class="form-control pl-0 form-control-line" name="nama_lowongan" value="<?= $lowongan['nama_lowongan'] ?>">
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <textarea name="deskripsi_lowongan" id="summernote"><?php echo $lowongan['deskripsi_lowongan']; ?></textarea>
              </div>
            </div>
            <div class=" form-group">
            ...
            <div class=" form-group">
              <div class="col-md-12">
                <img src="/lowongan/<?= $lowongan['gambar'] ?>" class="rounded" width="300" height="400" />
              </div>
            </div>
            <div class="form-group">
