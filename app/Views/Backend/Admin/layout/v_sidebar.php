 ...
 <aside class="left-sidebar" data-sidebarbg="skin6">
   ...
   <div class="scroll-sidebar">
     ...
     <nav class="sidebar-nav">
       <ul id="sidebarnav">
         <!-- User Profile-->
         <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= base_url('backend/admin/home') ?>" aria-expanded="false"><i class="mdi mr-2 mdi-home"></i><span class="hide-menu">Home</span></a></li>
         ...
         <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= base_url('backend/admin/home/rekomendasi_alumni') ?>" aria-expanded="false"><i class="mdi mr-2 mdi-account-check"></i><span class="hide-menu">Rekomendasi Alumni</span></a></li>
       </ul>
     </nav>
